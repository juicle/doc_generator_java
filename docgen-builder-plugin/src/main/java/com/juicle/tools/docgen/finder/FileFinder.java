...
public class FileFinder {
    ...
    public static List<File> findAllFileNeedToParse(BuilderMojo builderMojo) {
        ...
        if (StringUtils.isBlank(builderMojo.getPackages())) {
            throw new RuntimeException("设置扫描的路径");
        } else {
            builderMojo.setPackages(builderMojo.getPackages().trim());
        }
    ...
    public static File makeScanPackageFile(BuilderMojo builderMojo) {
        String scanBasePackagePath = makePackagePath(builderMojo.getPackages());
